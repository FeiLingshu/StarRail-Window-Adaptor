using StarRail_Window_Adapter.Watcher;
using System;
...
using static StarRail_Window_Adapter.Func.MsgBeep;
using UnhandledExceptionEventArgs = System.UnhandledExceptionEventArgs;

namespace StarRail_Window_Adapter
{
    /// <summary>
    /// 应用程序基础类
    /// </summary>
    internal static class Program
    {
        ...
        /// 全局guid常数
        /// </summary>
        private static readonly string GUID = "47383467-89A8-49C2-87AA-52A7DF9C9A58";
        /// <summary>
        /// 全局线程同步事件
        /// </summary>
        ...
        private static void Main(string[] args)
        {
            ...
            bool checkout = File.Exists($"{local}\\launcher.exe")
                && Directory.Exists($"{local}\\Game")
                && File.Exists($"{local}\\Game\\StarRail.exe");
        ...
        internal static void Exception_throw(Exception e)
        {
            ...
            MessageBox.Show($"[应用程序内部异常] [{DateTime.Now:yyyy/MM/dd HH:mm:ss}]"
                ...
                + $"\n位置:\n{e.StackTrace}"
                + "\n\nStarRail窗口化适配工具 - Exceptions Processed By FeiLingshu");
            // 强制退出程序进程
            Environment.Exit(0);
        }
    }
